...
export const collectionSortDefinitions = Object.freeze([
  ...
  Object.freeze({ key: "FINISHING", label: "Finishing", orderBy: "ct.finishing DESC, ci.obtained_at ASC, ci.card_instance_id ASC" }),
  ...
  Object.freeze({ key: "STRENGTH", label: "Strength", orderBy: "ct.strength DESC, ci.obtained_at ASC, ci.card_instance_id ASC" }),
